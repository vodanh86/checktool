...
abstract class Constant
{
    ...
    const BATTERY_STATUS = array("1" => "tốt", "2" => "Không tốt");
    const SCREEN_STATUS = array("1" => "tốt", "2" => "Không tốt");
    const CASE_STATUS = array("1" => "tốt", "2" => "Không tốt");
    const KEYBOARD_STATUS = array("1" => "tốt", "2" => "Không tốt");
}
